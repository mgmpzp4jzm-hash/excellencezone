...
const servicesData = [
  ...
  { icon: Waves, en: { title: "Massage — Regular", desc: "Specialized techniques to stimulate circulation, relieve tension, and restore radiance.", duration: "45 min" }, ar: { title: "مساج — عادي", desc: "تقنيات متخصصة تنشّط الدورة الدموية، تفك التكتيف، وترجّع نشاطك.", duration: "٤٥ دقيقة" } },
