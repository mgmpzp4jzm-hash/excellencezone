...
const reviews = [
  { name: { en: "Ahmed", ar: "أحمد" }, time: { en: "10 months ago", ar: "قبل ١٠ أشهر" }, text: { en: "My experience was great at the salon. I got a hair cut and a beard trim. In addition to, face mask and hair mask. Sherif was a real friendly and professional guy. I really appreciate him and his work. Thank you sherif.", ar: "تجربتي في الصالون كانت ممتازة. قصصت شعري وهذّبت لحيتي، بالإضافة إلى ماسك للوجه وماسك للشعر. كان شريف ودوداً ومحترفاً، وأقدّر له عمله الراقي. شكراً شريف." } },
  { name: { en: "Faisal Bakhsh", ar: "فيصل بخش" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Soufiane did a really good job — very good haircut.", ar: "سفيان قدّم عملاً ممتازاً — قصّة شعر رائعة." } },
  { name: { en: "Omar", ar: "عمر" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Suffyan cut my hair perfectly. Will definitely go back again.", ar: "قصّ سفيان شعري باحترافية تامّة، وسأعود إليه بالتأكيد." } },
  { name: { en: "Fahad Alalmai", ar: "فهد الألمعي" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Safwan the barber is soo good, he cut my hair good — I give him 5 stars.", ar: "صفوان حلاق ممتاز جداً، قصّ شعري بشكل رائع — أمنحه ٥ نجوم." } },
  { name: { en: "sultan alghamdi", ar: "سلطان الغامدي" }, time: { en: "5 months ago", ar: "قبل ٥ أشهر" }, text: { en: "It was an excellent experience. The staff is respectful and helpful. Sayed was my hairstylist and he was great.", ar: "كانت تجربة ممتازة. الفريق محترم ومتعاون، وكان سيد مصفّف شعري وقد أبدع في عمله." } },
  { name: { en: "Abdulrahman Aljehani", ar: "عبدالرحمن الجهني" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Soufyan is really skillful and served us in an amazing manner — I really appreciate such a good treat!", ar: "سفيان ماهر جداً وقدّم لنا خدمة رائعة — أقدّر له هذه المعاملة الراقية." } },
  { name: { en: "Hamza Alzaini", ar: "حمزة الزيني" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Very nice and good. I would like to thank my barber Sufyan — he is the best!", ar: "مكان لطيف وممتاز. أشكر حلاقي سفيان — هو الأفضل!" } },
  { name: { en: "Khalid Salman", ar: "خالد سلمان" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Safwan is really good with cutting hair and I am one of his customers. He is very kind and helpful.", ar: "صفوان ممتاز في قصّ الشعر وأنا من زبائنه الدائمين. لطيف ومتعاون جداً." } },
  { name: { en: "Youssif Abdellatif", ar: "يوسف عبداللطيف" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Really nice place. Soufiane cut my hair and as always it turned out very good. Highly recommend visiting.", ar: "مكان جميل حقاً. قصّ سفيان شعري وكالعادة جاءت النتيجة رائعة. أنصح بزيارته بشدة." } },
  { name: { en: "Rami Louai", ar: "رامي لؤي" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Soufiane cut my hair and tbh I never felt more confident before — the place is really good. Highly recommended.", ar: "قصّ سفيان شعري ولم أشعر بهذه الثقة من قبل — المكان رائع فعلاً. أنصح به بشدة." } },
  { name: { en: "Dawood", ar: "داود" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Amazing service and very happy with my haircut. Sufyan is a very skilled and professional barber. Would definitely go again and definitely recommend!", ar: "خدمة مذهلة وأنا سعيد جداً بقصّة شعري. سفيان حلاق ماهر ومحترف. سأعود بالتأكيد وأنصح به." } },
  { name: { en: "Mahmoud Alrifaiey", ar: "محمود الرفاعي" }, time: { en: "4 months ago", ar: "قبل ٤ أشهر" }, text: { en: "Recently visited this place and had a great experience. Special thanks to Sofyan — he's one of the best barbers, very professional, and always takes great care of his customers. Highly recommended!", ar: "زرت المكان مؤخراً وكانت تجربة رائعة. شكر خاص لسفيان — من أفضل الحلاقين، محترف جداً ويهتمّ بزبائنه دائماً. أنصح به بشدة." } },
  { name: { en: "Amjad bukary", ar: "أمجد بخاري" }, time: { en: "4 months ago", ar: "قبل ٤ أشهر" }, text: { en: "Sofyan is the best barber in Saudi. Very clean and professional barber shop. Hundred percent would recommend.", ar: "سفيان أفضل حلاق في السعودية. الصالون نظيف واحترافي جداً. أنصح به بشكل قاطع." } },
  { name: { en: "zumst y", ar: "زمست" }, time: { en: "4 months ago", ar: "قبل ٤ أشهر" }, text: { en: "Sofian is a really skilled barber who cares about his work and pays attention to the small details. You can tell he takes pride in what he does — highly recommend him.", ar: "سفيان حلاق ماهر فعلاً، يهتمّ بعمله ويُعنى بأدقّ التفاصيل. يظهر أنه يفخر بما يقدّمه — أنصح به بشدة." } },
  { name: { en: "fofo", ar: "فوفو" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Excellent place. My barber is Sofian. He really knows what he is doing — an expert in his field, with nice and gentle hands.", ar: "مكان ممتاز. حلاقي سفيان، يتقن عمله تماماً — خبير في مجاله وذو يدٍ لطيفة." } },
  { name: { en: "Jamal Abuzeid", ar: "جمال أبو زيد" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Soufiane is a very good barber and has a good attitude.", ar: "سفيان حلاق ممتاز ويتعامل بأسلوب راقٍ." } },
  { name: { en: "Abdullah Alhout", ar: "عبدالله الحوت" }, time: { en: "10 months ago", ar: "قبل ١٠ أشهر" }, text: { en: "I went here twice and one time with my 2 kids. They were lovely with them. Very elegant place, clean and super amazing team working there. I really loved it and wish them all the best.", ar: "زرت المكان مرّتين، إحداهما مع طفليّ، وكانوا لطفاء معهم جداً. مكان أنيق ونظيف وفريق رائع. أحببته كثيراً وأتمنى لهم التوفيق." } },
  { name: { en: "Yazan Alrifaiey", ar: "يزن الرفاعي" }, time: { en: "3 months ago", ar: "قبل ٣ أشهر" }, text: { en: "Sufyan — best barber.", ar: "سفيان — أفضل حلاق." } },
  { name: { en: "R Perera", ar: "ر. بيريرا" }, time: { en: "6 months ago", ar: "قبل ٦ أشهر" }, text: { en: "Great service 👏", ar: "خدمة رائعة 👏" } },
  { name: { en: "F 92", ar: "F 92" }, time: { en: "11 months ago", ar: "قبل ١١ شهراً" }, text: { en: "Saif, not a mistake.", ar: "سيف، اختيار موفّق." } },
  { name: { en: "Ammar Bawedan", ar: "عمار باوادان" }, time: { en: "a year ago", ar: "قبل عام" }, text: { en: "10/10 👏", ar: "١٠/١٠ 👏" } },
];
