...
const servicesData = [
  ...
  { icon: Sparkles, en: { title: "Perm — Long Lasting", desc: "A long-lasting perm treatment that gives your hair lasting texture and shape.", duration: "75 min" }, ar: { title: "بيرم — طويل الأمد", desc: "جلسة بيرم تدوم طويلاً، تمنح الشعر ملمساً وشكلاً يبقى معاك.", duration: "٧٥ دقيقة" } },
  { icon: Sparkles, en: { title: "Perm — Regular", desc: "A classic perm treatment to add volume and soft waves to your hair.", duration: "25 min" }, ar: { title: "بيرم — عادي", desc: "بيرم كلاسيكي يضيف كثافة وموجات ناعمة للشعر.", duration: "٢٥ دقيقة" } },
  { icon: Flower2, en: { title: "Moroccan Bath — Regular", desc: "A deeply cleansing body ritual using authentic black soap and kessa exfoliation.", duration: "35 min", link: "/moroccan-bath" }, ar: { title: "الحمام المغربي — عادي", desc: "جلسة تنظيف عميق للجسم بالصابون البلدي الأصلي وتقشير الكيسة.", duration: "٣٥ دقيقة", link: "/moroccan-bath" } },
  ...
  { icon: Waves, en: { title: "Massage — Regular", desc: "Specialized techniques to stimulate circulation, relieve tension, and restore radiance.", duration: "40 min" }, ar: { title: "مساج — عادي", desc: "تقنيات متخصصة تنشّط الدورة الدموية، تفك التكتيف، وترجّع نشاطك.", duration: "٤٠ دقيقة" } },
  { icon: Waves, en: { title: "Massage — King", desc: "An extended, deeply restorative massage session for full-body relaxation and renewal.", duration: "1 hour" }, ar: { title: "مساج — ملكي", desc: "جلسة مساج ممتدة وعميقة للاسترخاء الكامل وتجديد حيوية الجسم.", duration: "ساعة" } },
  { icon: Hand, en: { title: "Manicure", desc: "Meticulous hand care with attention to nail health, cuticles, and a clean finish.", duration: "1 hour 30 min" }, ar: { title: "مانيكير", desc: "عناية دقيقة باليدين — صحة الأظافر، الجلد الزائد، ولمسة نهائية نضيفة.", duration: "ساعة ونصف" } },
  { icon: Hand, en: { title: "Pedicure", desc: "Thorough foot care including exfoliation, nail grooming, and skin health.", duration: "1 hour 30 min" }, ar: { title: "باديكير", desc: "عناية شاملة بالقدمين — تقشير، ترتيب الأظافر، وصحة البشرة.", duration: "ساعة ونصف" } },
  { icon: Hand, en: { title: "Manicure & Pedicure", desc: "Complete hand and foot care in one session — nails, skin, and a polished finish.", duration: "3 hours" }, ar: { title: "مانيكير وباديكير", desc: "عناية كاملة باليدين والقدمين في جلسة واحدة — أظافر، بشرة، ولمعة نهائية.", duration: "٣ ساعات" } },
...
const team = [
  ...
  { name: { en: "Yassine", ar: "ياسين" }, role: { en: "Barber & Stylist · Perm · Manicure · Pedicure", ar: "حلاق ومصفّف · بيرم · مانيكير · باديكير" } },
