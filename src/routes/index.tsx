...
const servicesData = [
  ...
  { icon: Star, en: { title: "Beard Grooming & Shaving", desc: "Sharp line-ups, hot-towel shaves, and beard sculpting tailored to your face shape.", duration: "30 min" }, ar: { title: "العناية باللحية والحلاقة", desc: "تشذيب اللحية، حلاقة بالمنشفة الساخنة، وتفصيل على شكل وجهك.", duration: "٣٠ دقيقة" } },
