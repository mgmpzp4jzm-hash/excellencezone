...
const t = {
  ...
  ar: {
    ...
    about: { tag: "فكرتنا", h: "مكان مخصوص لكل ضيف يبي الأحسن.", p: "في صالون منطقة الامتياز نهتم بأدق التفاصيل — من أول ما تطّل علينا لين تشوف نفسك بالمراية — عشان نطلّعك بتجربة مرتبة تجمع الفخامة والراحة. مستوانا ثابت، وراحتك هي الأهم عندنا." },
